...
class CpuContainerCrawler(IContainerCrawler):
    ...
    def get_cpu_cgroup_path(self, node='cpuacct.usage'):
        ...
        return os.path.join(cgroup_dir, node)
    ...
    def crawl(self, container_id, avoid_setns=False, per_cpu=False, **kwargs):
        ...
        (cpu_usage_t1, prev_time) = (
            self._get_prev_container_cpu_times(container_id))
        ...
        if cpu_usage_t1:
            ...
            with open(self.get_cpu_cgroup_path(stat_file_name),
                      'r') as f:
        ...
        self._save_container_cpu_times(container_id,
                                       cpu_usage_t2)

        cpu_user_system = {}
        path = self.get_cpu_cgroup_path('cpuacct.stat')
