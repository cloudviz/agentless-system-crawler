...
class SingleContainerTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.container = self.docker.create_container(image='alpine:latest',
    ...
    def testCrawlContainer1(self):
        ...
        options = {
            ...
            'options': {
                ...
                'file': {
                    'avoid_setns': False,
                    'exclude_dirs': ['boot', 'dev', 'proc', 'sys', 'mnt',
                                     'tmp', 'var/cache', 'usr/share/man',
                                     'usr/share/doc', 'usr/share/mime'],
                    'root_dir': '/'
                },
                ...
                'config': {
                    'avoid_setns': False,
                    'exclude_dirs': ['dev', 'proc', 'mnt', 'tmp', 'var/cache',
