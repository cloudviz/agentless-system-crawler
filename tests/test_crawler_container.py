    ...
    # writing other tests easier
        options = {
            ...
            'options': {
                ...
                'file': {
                    'avoid_setns': False,
                    'exclude_dirs': ['boot', 'dev', 'proc', 'sys', 'mnt', 'tmp', 'var/cache', 'usr/share/man', 'usr/share/doc',
                                     'usr/share/mime'],
                    'root_dir': '/'
                },
                ...
                'config': {
                    'avoid_setns': False,
                    'exclude_dirs': ['dev', 'proc', 'mnt', 'tmp', 'var/cache', 'usr/share/man', 'usr/share/doc',
                                     'usr/share/mime'],
                    'root_dir': '/',
                    'discover_config_files': True,
                    'known_config_files': ['etc/passwd', 'etc/group', 'etc/hosts', 'etc/hostname', 'etc/mtab', 'etc/fstab',
                                           'etc/aliases', 'etc/ssh/ssh_config', 'etc/ssh/sshd_config', 'etc/sudoers']
                },
                'metadata': {
                    'extra_metadata': {},
