...
def mocked_start_child(params, pass_fds, null_fds, **kwargs):
    ...
    return start_child(['sleep', '1'], pass_fds, null_fds)


def mocked_start_child_fprobe_fail(params, pass_fds, null_fds, **kwargs):
    if params[0] == 'fprobe':
        return start_child(['___no_such_file'], pass_fds, null_fds, **kwargs)
    return start_child(['sleep', '1'], pass_fds, null_fds, **kwargs)


def mocked_start_child_collector_fail(params, pass_fds, null_fds, **kwargs):
    if params[0] == 'socket-datacollector':
        return start_child(['___no_such_file'], pass_fds, null_fds, **kwargs)
    return start_child(['sleep', '1'], pass_fds, null_fds, **kwargs)
