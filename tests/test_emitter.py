...
class NamespaceLibTests(unittest.TestCase):
    ...
    def _test_emitter_csv_simple_stdout(self):
        with Emitter(urls=['stdout://']) as emitter:
            emitter.emit("dummy_feature", {'test': 'bla', 'test2': 12345,
                                           'test3': 12345.0,
                                           'test4': 12345.00000},
                         'dummy_feature')
    ...
    def test_emitter_csv_simple_file(self):
        urls = ['file:///tmp/test_emitter_csv_simple_file']
        with Emitter(urls=urls) as emitter:
            emitter.emit("dummy_feature", {'test': 'bla', 'test2': 12345,
                                           'test3': 12345.0,
                                           'test4': 12345.00000},
                         'dummy_feature')
    ...
    def _test_emitter_graphite_simple_stdout(self):
        ...
        with Emitter(urls=['stdout://'], emitter_args=metadata,
    ...
    def test_emitter_graphite_simple_file(self):
        ...
        with Emitter(urls=['file:///tmp/test_emitter_graphite_simple_file'],
            ...
            emitter.emit("dummy_feature", {
                         'test': 'bla', 'test2': 12345, 'test3': 12345.0,
                         'test4': 12345.00000}, 'dummy_feature')
